    ...
    return function a(o, s, c) {
        ...
        3: [function(e, t, r) {
            ...
            Object.defineProperty(r, "shimGetDisplayMedia", {
                ...
                o.RTCPeerConnection.prototype.removeStream = function(e) {
                    this._streams = this._streams || {}, this._reverseStreams = this._reverseStreams || {}, t.apply(this, [this._streams[e.id] || e]), delete this._reverseStreams[this._streams[e.id] ? this._streams[e.id].id : e.id], delete this._streams[e.id]
                ...
                var i = 0 === n.RTCPeerConnection.prototype.addIceCandidate.length;
                ...
                n.RTCPeerConnection.prototype.addIceCandidate = function(e, t) {
                    return i || e ? r.version < 78 && e && "" === e.candidate ? Promise.resolve() : a.apply(this, arguments) : (t && t.apply(null), Promise.resolve())
                }
                ...
                function n(r, n) {
                    ...
                    if (r && "object" === d(r.video)) {
                        ...
                        if (i && ("user" === i.exact || "environment" === i.exact || "user" === i.ideal || "environment" === i.ideal) && (!o.mediaDevices.getSupportedConstraints || !o.mediaDevices.getSupportedConstraints().facingMode || t)) {
                            ...
                            var a = void 0;
                            if ("environment" === i.exact || "environment" === i.ideal ? a = ["back", "rear"] : "user" !== i.exact && "user" !== i.ideal || (a = ["front"]), a) return o.mediaDevices.enumerateDevices().then(function(e) {
        ...
        6: [function(e, t, r) {
            ...
            r.shimRTCIceCandidate = function(t) {
                ...
                t.RTCIceCandidate = function(e) {
                    ...
                    return new i(e)
                }, t.RTCIceCandidate.prototype = i.prototype, o.wrapPeerConnectionEvent(t, "icecandidate", function(e) {
                ...
                e.RTCPeerConnection.prototype.setRemoteDescription = function(e) {
                    var t, r;
                    this._sctp = null, "chrome" === c.browser && 76 <= c.version && ("plan-b" === this.getConfiguration().sdpSemantics && Object.defineProperty(this, "sctp", {
                        get: function() {
                            return void 0 === this._sctp ? null : this._sctp
                        },
                        enumerable: !0,
                    ...
                    if (function(e) {
                        ...
                        var n = function(e) {
                            ...
                            i = (t = n, r = 65536, "firefox" === c.browser && (r = c.version < 57 ? -1 === t ? 16384 : 2147483637 : c.version < 60 ? 57 === c.version ? 65535 : 65536 : 2147483637), r),
                            a = function(e, t) {
                                var r = 65536;
                            ...
                            o = void 0;
                        o = 0 === i && 0 === a ? Number.POSITIVE_INFINITY : 0 === i || 0 === a ? Math.max(i, a) : Math.min(i, a);
                        var s = {};
        ...
        14: [function(e, t, r) {
            ...
            r.shimLocalStreamsAPI = function(e) {
                if ("object" !== (void 0 === e ? "undefined" : n(e)) || !e.RTCPeerConnection) return;
                ...
                if (!("addStream" in e.RTCPeerConnection.prototype)) {
                    ...
                    e.RTCPeerConnection.prototype.addStream = function(t) {
                        ...
                        for (var t = this, r = arguments.length, n = Array(1 < r ? r - 1 : 0), i = 1; i < r; i++) n[i - 1] = arguments[i];
                    ...
                    return w.canTrickleIceCandidates = !!t && 0 <= t.substr(14).split(" ").indexOf("trickle"), e.forEach(function(e, t) {
                        ...
                        if (i || "application" === n && ("DTLS/SCTP" === a || "UDP/DTLS/SCTP" === a)) w.transceivers[t] = {
                            ...
                            var T = G.parseRtcpParameters(e),
                                ...
                                R = G.matchPrefix(e, "a=candidate:").map(function(e) {
                            ...
                            if (("offer" === _.type || "answer" === _.type) && !i && O && 0 < t && w.transceivers[t] && (w._disposeIceAndDtlsTransports(t), w.transceivers[t].iceGatherer = w.transceivers[0].iceGatherer, w.transceivers[t].iceTransport = w.transceivers[0].iceTransport, w.transceivers[t].dtlsTransport = w.transceivers[0].dtlsTransport, w.transceivers[t].rtpSender && w.transceivers[t].rtpSender.setTransport(w.transceivers[0].dtlsTransport), w.transceivers[t].rtpReceiver && w.transceivers[t].rtpReceiver.setTransport(w.transceivers[0].dtlsTransport)), "offer" !== _.type || i) {
                                if ("answer" === _.type && !i) {
                                    p = (d = w.transceivers[t]).iceGatherer, u = d.iceTransport, f = d.dtlsTransport, l = d.rtpReceiver, m = d.sendEncodingParameters, v = d.localCapabilities, w.transceivers[t].recvEncodingParameters = h, w.transceivers[t].remoteCapabilities = S, w.transceivers[t].rtcpParameters = T, R.length && "new" === u.state && (!D && !P || O && 0 !== t ? R.forEach(function(e) {
                                        N(d.iceTransport, e)
                                    ...
                                    }).length && d.sendEncodingParameters[0].rtx && delete d.sendEncodingParameters[0].rtx, w._transceive(d, "sendrecv" === o || "recvonly" === o, "sendrecv" === o || "sendonly" === o), !l || "sendrecv" !== o && "sendonly" !== o ? delete d.rtpReceiver : (y = l.track, s ? (k[s.stream] || (k[s.stream] = new I.MediaStream), L(y, k[s.stream]), x.push([y, l, k[s.stream]])) : (k.default || (k.default = new I.MediaStream), L(y, k.default), x.push([y, l, k.default])))
                                }
                            } else {
                                ...
                                if ("sendrecv" === o || "sendonly" === o) {
                                    ...
                                    }), k[s.stream]) : (k.default || (k.default = new I.MediaStream), k.default)), b && (L(y, b), d.associatedRemoteMediaStreams.push(b)), x.push([y, l, b])
