(function() {
    ...
    function H(a, c) {
        if (c) a: {
            ...
            a = a[a.length - 1];d = b[a];c = c(d);c != d && null != c && F(b, a, {
                configurable: !0,
                writable: !0,
                value: c
            })
    ...
    function ka(a, c) {
        O(a.g);
        var b = a.g.h;
        if (b) return la(a, "return" in b ? b["return"] : function(d) {
            return {
                value: d,
                done: !0
            }
    ...
    H("Promise", function(a) {
        ...
        c.race = function(e) {
            return new c(function(g, h) {
                for (var l = A(e), n = l.next(); !n.done; n = l.next()) d(n.value).D(g, h)
            })
        };
        c.all = function(e) {
            var g = A(e),
    ...
    Aa.prototype.toArrayBuffer = function() {
        return X(this, function c() {
            ...
            return V(c, function(f) {
                return 1 == f.g ? (b.graph.url ? f = R(f, fetch(b.locateFile(b.graph.url, b.g)), 3) : (f.g = 2, f = void 0), f) : 2 != f.g && (d = f.j, d.body) ? f.return(d.arrayBuffer()) : f.return(new ArrayBuffer(0))
            })
        })
    };
    ...
    function Ba() {
        return X(this, function c() {
            return V(c, function(b) {
                switch (b.g) {
                    case 1:
                        return b.m = 2, R(b, WebAssembly.instantiate(va), 4);
                    case 4:
                        b.g = 3;
                        b.m = 0;
                        break;
            ...
            return V(b, function(p) {
                switch (p.g) {
                    case 1:
                        ...
                        return R(p, Ba(), 2);
                    case 2:
                        return e = p.j, R(p, Promise.all(k.map(function(u) {
                    ...
                    case 3:
                        return g = window.createMediapipeSolutionsWasm,
                            h = window.createMediapipeSolutionsPackedAssets, R(p, g(h), 4);
                    case 4:
                        return d.g = p.j, d.m = document.createElement("canvas"), d.g.canvas = d.m, d.g.createContext(d.m, !0, !0, {}), d.i = new d.g.SolutionWasm, l = new Aa(d.h.graph, d.locateFile, d.F), R(p, d.loadGraph(l), 5);
                    case 5:
                        if (d.h.listeners)
    ...
    Y.prototype.loadGraph = function(a) {
        return X(this, function b() {
            ...
            return V(b, function(k) {
                if (1 == k.g) return R(k, a.toArrayBuffer(), 2);
                d = k.j;
                f.i.loadGraph(d);
                k.g = 0
            })
    ...
    Y.prototype.send = function(a, c) {
        return X(this, function d() {
            ...
            return V(d, function(p) {
                ...
                if (3 != p.g) return R(p, f.initialize(), 3);
                ...
                for (h = g.next(); !h.done; h = g.next())
                    if (l = h.value, n = f.h.inputs[l]) {
                        ...
                        y = r;q = n.stream;e.pushTexture2d(Object.assign(Object.assign({}, y), {
                            stream: q,
                            timestamp: k
                        }))
                    }
