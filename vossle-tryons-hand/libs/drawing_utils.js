    ...
    */
    ...
    function q(a, c) {
        if (c) a: {
            ...
            a = a[a.length - 1];d = b[a];c = c(d);c != d && null != c && m(b, a, {
                configurable: !0,
                writable: !0,
                value: c
            })
    ...
    q("Int8Array.prototype.fill", t);
    q("Uint8Array.prototype.fill", t);
    q("Uint8ClampedArray.prototype.fill", t);
    q("Int16Array.prototype.fill", t);
    q("Uint16Array.prototype.fill", t);
    q("Int32Array.prototype.fill", t);
    q("Uint32Array.prototype.fill", t);
    q("Float32Array.prototype.fill", t);
    q("Float64Array.prototype.fill", t);
    var u = this || self;
    ...
    v("drawLandmarks", function(a, c, b) {
        if (c) {
            ...
            for (var f = c.next(); !f.done; f = c.next())
                if (f = f.value, void 0 !== f && !(void 0 !== f.visibility && .5 > f.visibility)) {
        ...
        if (c && b) {
            ...
            for (var g = b.next(); !g.done; g = b.next()) {
                ...
                g && l && (a.strokeStyle = y(d.color, {
                    ...
                    from: g,
                    to: l
                }), a.moveTo(g.x * e.width, g.y * e.height), a.lineTo(l.x * e.width, l.y * e.height));
                ++f;
                a.stroke()
            }
            a.restore()
